...
(function(c) {
	...
	c.fn.emojiInit = function(b) {
		...
		if (void 0 == b || 0 >= b.length) option.error(null, "target object is undefined");
			...
			b.after("<i id='faceEnter' onclick='showFaceBlock()' style='padding: 5px;position: absolute;right: 105px;cursor: pointer;font: normal normal normal 14px/1 FontAwesome;'>😃</i>");
			b.after("<div id='faceBlock' style='background:rgb(216, 216, 216);border-radius: 12px;display: none;position: absolute;border: 1px solid #e2e2e2;padding: 5px;right: 30px;top: -35px;width: 300px;'>" + a + "</div>");
